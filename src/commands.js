...
export const CATALOGUE = [
  ...
  { scope: "cli", name: "send", args: "<agentId> <inboxId> <요청>|--file <경로>", summary: "PM에게 task 생성", example: 'pilo send 3 42 "로그인 리다이렉트 고쳐줘"' },
  { scope: "cli", name: "reply", args: "<inboxId> <본문>|--file <경로> [--with-results]", summary: "final_reply 저장 — --with-results 면 머리말 아래 PM 결과를 붙임", example: 'pilo reply 42 "고쳤음. 재시작 필요" --with-results' },
