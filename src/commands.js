...
export const CATALOGUE = [
  ...
  { scope: "cli", name: "hold", args: "<taskId> <기다리는 것>", summary: "바깥 일을 기다리는 중으로 표시", example: 'pilo hold 812 "CI 통과 기다리는 중"' },
  { scope: "cli", name: "resume", args: "<taskId>", summary: "보류 해제하고 대기열로", example: "pilo resume 812" },
  { scope: "cli", name: "limited", args: "<agentId> --until <시각>", summary: "사용량 한도 신고 (until 없으면 해제)", example: "pilo limited 6 --until 2026-09-08T18:00:00Z" },
