...
// The terminal answers with 1 or 2; anything else keeps the safe default.
export function setAmbiguousWidth(n) {
  ambiguousWidth = n === 2 ? 2 : 1;
}
...
export const cols = (s) =>
  [...String(s).replace(/\x1b\[[0-9;]*m/g, "")].reduce((n, ch) => n + charWidth(ch), 0);
